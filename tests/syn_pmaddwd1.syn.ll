; CHECK: call <8 x i32> @llvm.x86.avx2.pmadd.wd(<16 x i16> %wide.vec, <16 x i16> <i16 1, i16 -1, i16 1, i16 -1, i16 1, i16 -1, i16 1, i16 -1, i16 1, i16 -1, i16 1, i16 -1, i16 1, i16 -1, i16 1, i16 -1>)
