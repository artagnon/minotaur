; CHECK: call <2 x float> @llvm.minimum.v2f32(<2 x float> <float 0.000000e+00, float 1.000000e+00>, <2 x float> %x)
; CHECK: call <2 x float> @llvm.minimum.v2f32(<2 x float> %y, <2 x float> <float 1.000000e+00, float 0.000000e+00>)
